            ...
            >
                <Box sx={{ pt: 1, display: 'flex', flexDirection: 'column', gap: 2 }}>
                    ...
                    <CustomSelect
                        ...
                        options={[{ label: 'Pharmacist', value: 'Pharmacist' }, { label: 'Cashier', value: 'Cashier' }, { label: 'Manager', value: 'Manager' }, { label: 'Delivery Agent', value: 'Delivery Agent' }]}
                    />
                    <CustomSelect
                        label="Assign Shop"
                        required
                        value={editStaff?.shop || ''}
                        options={Array.from(new Set(DUMMY_STAFF.map(s => s.shop))).map(shop => ({ label: shop, value: shop }))}
                    />
                    <CustomTextField
                        label="Phone Number"
